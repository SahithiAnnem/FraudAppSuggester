...
while(rs.next())
{
	PreparedStatement pst1=con.prepareStatement("select fpath from fileupload where appid=?");
...
<Th><%= rs.getString(1) %></th>
  ...
  <a href="downloadapp.jsp?fn=<%= rs1.getString(1) %>&appid<%= rs.getString(1) %>">Download</a></th>
