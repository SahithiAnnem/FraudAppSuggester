...
%>
		<table>	 
<form action="uploadFile1.jsp?id=<%= id %>" method="post" name="upform"  enctype="multipart/form-data">
   <Tr><th colspan=2 align="center"><font face="Trebuchet MS" size="7" color="#0CBEAC">Upload File</font></b></th></tr>
               
                        <tr>  
                    <td align="left"><font face="Verdana" color="#E4DB6B" size="5"><b>Select a file to upload :</b></font></td>  
                        </tr>  
                        <tr>  
                            <td align="left">  
